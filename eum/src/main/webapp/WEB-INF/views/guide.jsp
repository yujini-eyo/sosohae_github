...
<div class="page-guide" role="region" aria-labelledby="guideTitle">
	<div class="container">
		...
		<section class="hero" aria-labelledby="guideTitle">
			...
			<p class="subtitle">
				전구 교체, 약국 심부름, 병원 동행처럼 <strong>작지만 꼭 필요한 도움</strong>을 <strong>근처
					이웃</strong>과 연결하는 방법을 단계별로 안내합니다.
			</p>
		</section>
			...
			<div class="cards">
				<article class="card">
					...
					<ul class="list">
						...
						<li>문자 본인인증 후 글 작성 가능</li>
					</ul>
					<div class="card-cta">
						<button class="btn outline" type="button"
							data-href="${ctx}/member/memberForm.do">회원가입</button>
					</div>
				</article>
				...
				<article class="card">
					<h3>도우미(봉사자)</h3>
					<ul class="list">
						<li>선택: <strong>1365 연동</strong>, 청소년/기관 인증
						</li>
						<li>활동 이력과 인증 상태가 프로필에 반영됩니다.</li>
					</ul>
					<div class="card-cta">
						<button class="btn outline" type="button"
							data-href="${ctx}/member/memberForm.do">회원가입</button>
		...
		<section id="elder" aria-labelledby="elderTitle">
			...
			<div class="steps">
				<article class="step">
					<h3>1) 글 작성</h3>
					<p>카테고리/제목/지역/희망일시/포인트(선택)/사진(선택) 입력</p>
				</article>
				<article class="step">
					<h3>2) 등록</h3>
					<p>등록 후 도우미의 신청을 기다립니다(‘비상 요청’은 상단 고정)</p>
				</article>
				<article class="step">
					<h3>3) 신청자 확인</h3>
					<p>프로필·활동 이력을 보고 1명을 선택해 수락</p>
				</article>
				<article class="step">
					<h3>4) 진행</h3>
					<p>채팅/전화로 일정 조율 → 완료 후 서로 평가</p>
				</article>
			</div>
			<div class="box hint">
				<ul class="list">
					<li>하루 <strong>1건</strong>만 등록 가능(중복/스팸 방지)
					</li>
		...
		<section id="helper" aria-labelledby="helperTitle">
			...
			<div class="steps">
				<article class="step">
					<h3>1) 목록 확인</h3>
					<p>리스트/카드/지도 보기에서 내 주변 요청을 탐색</p>
				</article>
				<article class="step">
					<h3>2) 상세 열람</h3>
					<p>제목·세부내용·희망일시·지역·포인트 확인</p>
				</article>
				<article class="step">
					<h3>3) 신청/취소</h3>
					<p>신청 후 사정이 바뀌면 취소 가능</p>
				</article>
				<article class="step">
					<h3>4) 매칭</h3>
					<p>수락되면 채팅 가능, 다른 도우미는 신청 불가</p>
				</article>
			</div>
		</section>
		...
		<section id="match" aria-labelledby="matchTitle">
			...
			<div class="cards">
				<article class="card">
					<h3>매칭</h3>
					<ul class="list">
						<li>어르신이 <strong>1명 수락</strong>하면 <strong>매칭 완료</strong>로
							표시됩니다.
						</li>
						<li>다른 신청은 자동으로 마감됩니다.</li>
					</ul>
				</article>
				<article class="card">
					<h3>진행/완료</h3>
					<ul class="list">
						<li>예정 시간에 방문·수행합니다.</li>
						<li>완료 시 <strong>완료</strong>, 취소 시 <strong>취소</strong> 상태로
							표시됩니다.
						</li>
					</ul>
				</article>
				<article class="card">
					<h3>평가/인증</h3>
					<ul class="list">
						<li>서로 별점(1~5)과 한줄평을 남길 수 있습니다.</li>
						<li>1365 연동 및 활동 횟수 등 인증 상태는 프로필에서 확인할 수 있습니다.</li>
					</ul>
				</article>
			</div>
		</section>
			...
			<div class="cards">
				<article class="card">
					...
					<ul class="list">
						...
						<li>‘비상 요청’은 상단 우선 노출과 함께 관리자에게 알림이 전송됩니다.</li>
					</ul>
				</article>
				<article class="card">
					<h3>안전 수칙</h3>
					<ul class="list">
						<li>과도한 금전 요구는 즉시 신고하세요. 가능하면 플랫폼 내 채팅을 우선 사용하세요.</li>
						<li>개인정보는 매칭 후 필요한 범위에서만 공유합니다.</li>
					</ul>
				</article>
			</div>
		</section>
		...
		<section id="faq" aria-labelledby="faqTitle">
			...
			<details>
				...
				<p>
					중복/스팸 방지를 위해 <strong>1일 1건</strong>만 가능합니다. 긴급한 상황은 ‘비상 요청’을 사용해
					주세요.
				</p>
			</details>
			<details>
		...
		<!-- 마지막 CTA(유지) -->
		<section aria-label="바로 시작하기"
			style="text-align: center; margin-bottom: 40px;">
			<button class="btn primary" type="button"
				data-href="${ctx}/help/write.do">지금 도움 요청하기</button>
			<button class="btn ghost" type="button"
				data-href="${ctx}/board/listArticles.do">요청 목록 보기</button>
		</section>
	</div>
</div>
