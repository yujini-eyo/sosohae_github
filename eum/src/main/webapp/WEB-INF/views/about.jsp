...
<div class="page-about" role="region" aria-labelledby="aboutTitle">
  <div class="container">
    ...
    <section id="why" aria-labelledby="whyTitle">
      ...
      <div class="cards">
        <article class="card">
          <h3>일상 속 불편 해결</h3>
          <ul class="list">
            <li>혼자 하기 어려운 일을 빠르게 도움 연결</li>
            <li>전문 서비스보다 간편하고 근거리</li>
          </ul>
        </article>
        <article class="card">
          <h3>이웃과의 연결</h3>
          <ul class="list">
            <li>지역 공동체 회복과 재참여 유도</li>
            <li>따뜻한 상호작용의 확산</li>
          </ul>
        </article>
      </div>
    ...
    <section id="flow" aria-labelledby="flowTitle">
      ...
      <div class="steps">
        <article class="step"><h3>1) 글 작성</h3><p>필요한 도움을 간단히 등록</p></article>
        <article class="step"><h3>2) 신청</h3><p>도우미가 지원, 프로필/이력 확인</p></article>
        <article class="step"><h3>3) 매칭</h3><p>1명 수락 시 매칭 완료, 다른 신청 마감</p></article>
        <article class="step"><h3>4) 수행/평가</h3><p>채팅·위치 공유로 진행, 완료 후 평가</p></article>
      </div>
      <div class="box" style="margin-top:12px;">
        <ul class="list">
          <li>요청 제한: 하루 1건, 08:00~20:00 등록 권장</li>
          <li>‘비상 요청’은 상단 고정 및 관리자 알림</li>
        </ul>
      </div>
    </section>
    ...
    <section id="trust" aria-labelledby="trustTitle">
      ...
      <div class="cards">
        <article class="card">
          ...
          <ul class="list">
            <li>휴대폰 문자 인증 필수</li>
            <li>도우미: 청소년/기관 인증(선택), 1365 연동</li>
          </ul>
        </article>
        <article class="card">
          <h3>개인정보 최소화</h3>
    ...
    <section id="forwhom" aria-labelledby="whoTitle">
      ...
      <div class="cards">
        <article class="card">
          <h3>어르신/1인가구</h3>
          <p class="note">전구 교체·장보기·동행 등 생활 불편 해결</p>
        </article>
        <article class="card">
          <h3>도우미(이웃)</h3>
          <p class="note">시간을 나누는 주민, 청소년·대학생, 봉사자</p>
        </article>
        <article class="card">
          <h3>보호자</h3>
          <p class="note">대신 글 작성 및 진행 상황 열람(계정 연동)</p>
        </article>
        <article class="card">
          <h3>지역 기관</h3>
          <p class="note">복지관·청소년수련관 등 1365 등록 기관 연계</p>
        </article>
      </div>
    </section>

    <!-- FAQ -->
    <section id="faq" aria-labelledby="faqTitle" class="mb-40">
      <h2 id="faqTitle">자주 묻는 질문</h2>
      <details>
        <summary>비용이 드나요?</summary>
        <p>소액 보상 또는 봉사 포인트로 진행됩니다. 금전 요구가 과도하면 신고해 주세요.</p>
      </details>
      <details>
        <summary>누구나 도우미가 될 수 있나요?</summary>
        <p>가입과 문자 인증 후 가능합니다. 1365/청소년/기관 인증을 추가하면 신뢰도가 올라갑니다.</p>
      </details>
      <details>
        <summary>위치 정보는 안전한가요?</summary>
        <p>매칭/수행 시간에만 임시로 공유되며, 만료 시 자동 중지됩니다.</p>
      </details>
    </section>
