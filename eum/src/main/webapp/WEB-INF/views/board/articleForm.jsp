	...
	<form id="articleForm" method="post"
		...
		<section class="card" id="wizard">
			...
			<div class="hd" data-step="1" tabindex="0">
				<span class="stepnum">1</span> <span class="label">무엇을
					도와드릴까요?</span> <span class="hint">클릭하여 선택하세요.</span>
			</div>
			...
			<div class="hd" data-step="2" tabindex="0">
				<span class="stepnum">2</span> <span class="label">어디에서
					필요하신가요?</span> <span class="hint">클릭하여 선택하세요.</span>
			</div>
			...
			<div class="hd" data-step="3" tabindex="0">
				<span class="stepnum">3</span> <span class="label">언제 도와드릴까요?</span>
			...
			<div class="hd" data-step="4" tabindex="0">
				<span class="stepnum">4</span> <span class="label">긴급도</span> <span
					class="hint">클릭하여 선택하세요.</span>
			</div>
			...
			<div class="hd" data-step="5" tabindex="0">
				<span class="stepnum">5</span> <span class="label">확인 /
					제목(선택)</span> <span class="hint">클릭하여 선택하세요.</span>
			</div>
		...
		<section class="card" style="margin-top: 14px">
			<div class="hd" tabindex="-1" style="cursor: default">
				<span class="stepnum">✓</span> <span class="label">요약</span>
			</div>
			<div class="bd">
				<div class="sum" id="summary">
					<span class="chip">유형: -</span> <span class="chip">지역: -</span> <span
						class="chip">날짜: -</span> <span class="chip">시간: -</span> <span
						class="chip">긴급도: 일반</span> <span class="chip">권장 포인트: 100
						P</span>
				</div>
				<div class="tiny" style="margin-top: 8px">기준 100P/시간 · 긴급 시
					+30%</div>
			</div>
		</section>
		...
		<section class="card" style="margin-top: 14px">
			<div class="hd" tabindex="-1" style="cursor: default">
				<span class="stepnum">✎</span> <span class="label">상세 내용</span>
			</div>
			<div class="bd">
				<!-- 보이는 상세 내용 (name 제거) -->
				<textarea id="contentDetail" rows="8"
					placeholder="상세 요청 내용을 작성해 주세요. 예) 병원 동행, 접수/수납 도움, 예상 소요 1시간 등"></textarea>

				<!-- 서버 제출용: name="content"는 이 hidden 하나만 -->
				<textarea id="contentHidden" name="content" hidden></textarea>

				<!-- <input type="file" name="imageFile" accept="image/*" /> -->

				<!-- ✅ 여기 추가: 폼 위저드 값들을 서버로 넘기기 위한 hidden 필드 -->
				<input type="hidden" name="svcType" id="svcType"> <input
					type="hidden" name="region" id="regionHidden"> <input
					type="hidden" name="reqAt" id="reqAt"> <input type="hidden"
					name="urgency" id="urgencyHidden" value="일반"> <input
					type="hidden" name="points" id="pointsHidden" value="100">
			</div>
		</section>
