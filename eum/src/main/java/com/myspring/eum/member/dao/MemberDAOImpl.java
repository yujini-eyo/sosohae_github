...
public class MemberDAOImpl implements MemberDAO {
  ...
  public int insertMember(MemberVO vo){ return sqlSession.insert(NS+"insertMember", vo); }
  public MemberVO login(MemberVO vo){ return (MemberVO) sqlSession.selectOne(NS+"loginById", vo); }
