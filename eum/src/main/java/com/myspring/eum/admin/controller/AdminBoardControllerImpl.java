...
public class AdminBoardControllerImpl {
    ...
    public ResponseEntity<String> addNewArticle(MultipartHttpServletRequest multipartRequest,
        ...
        return adminBoardService.addNewArticle(multipartRequest, response);
    }
    ...
    public ResponseEntity<String> handleMethodNotAllowed(HttpServletRequest request, HttpRequestMethodNotSupportedException ex) {
        ...
        return new ResponseEntity<String>(msg, h, HttpStatus.METHOD_NOT_ALLOWED);
    }
}
